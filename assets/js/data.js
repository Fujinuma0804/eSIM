    ...
    "アジア": [
        {
            ...
            info: [
                ...
                { icon: 'info_outline', title: 'APN', text: 'mobile' },
        ...
        },
        {
            ...
            info: [
                ...
                { icon: 'add', title: 'インストール方法', text: 'QRコードまたは手動' },
                { icon: 'date_range', title: 'eSIM有効期限', text: '発行から30日以内にインストールしてください' },
                { icon: 'info_outline', title: 'APN', text: 'mobile.three.com.hk' },
                { icon: 'repeat', title: '容量追加', text: '不可（eSIMの再購入は可能）' }
            ],
        ...
        },
        {
            ...
            info: [
                ...
                { icon: 'add', title: 'インストール方法', text: 'QRコードまたは手動' },
                { icon: 'date_range', title: 'eSIM有効期限', text: '発行から30日以内にインストールしてください' },
                { icon: 'info_outline', title: 'APN', text: '3gnet' },
                { icon: 'repeat', title: '容量追加', text: '不可（eSIMの再購入は可能）' }
            ],
